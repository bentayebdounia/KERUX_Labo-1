...
CREATE TABLE fournisseur (
    ...
    id_fournisseur INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 999 CACHE 1 ) PRIMARY KEY,
...
CREATE TABLE bon (
    id_bon INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 999 CACHE 1 ) PRIMARY KEY,
    fk_fournisseur INT REFERENCES fournisseur(id_fournisseur),
