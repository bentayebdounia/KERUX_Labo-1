...
router.put(
  "/ajouterCoupageEnStock/:id_enregistrement",
  coupage.modifierProcessCoupage
);
...
router.get(
  ...
  coupage.getProcessByEtapes_categorie
);
router.get(
  "/getProcessByEtapes_produit/:nom_produit",
  coupage.getProcessByEtapes_produit
);
router.get(
  "/getProcessByEtapes_idGnerate/:id_gnerate",
  coupage.getProcessByEtapes_idGnerate
);
