...
postProduit = (req , res ) => {
    ...
    pool.query(queries.postProduit, [fk_categorie, nom_produit, duree_experation], (error, result) => {
        if (error) throw error 
...
getProduitBy_Categorie = (req, res) => {
    ...
    pool.query(queries.getProduitByCategorie, [nom_categorie], 
         (error, result) => {
            if (error) throw error 
...
getCategorie = (req, res) => {
    pool.query(queries.getCategorie, 
         (error, result) => {
            if (error) throw error 
