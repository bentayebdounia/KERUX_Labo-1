...
ajouterAlert = (req, res) => {
  ...
  pool.query(
    queries.ajouterAlert,
    [fk_processs, date_alert, existe],
...
updateAlert = (req, res) => {
  ...
  pool.query(queries.updateAlert, [existe, fk_processs], (error, result) => {
...
updateDateAlert = (req, res) => {
  ...
  pool.query(
    queries.updateDateAlert,
    [date_alert, fk_processs],
    (error, result) => {
      if (error) throw error;
...
countAlert = (req, res) => {
  ...
  var date_alert = new Date();
  pool.query(queries.countAlert, [date_alert], (error, result) => {
    if (error) throw error;
...
countAlertPrimary = (req, res) => {
  ...
  pool.query(queries.countAlertPrimary, [date_alert], (error, result) => {
    if (error) throw error;
    res.status(200).json(result.rows);
  });
};
...
countAlertEtape = (req, res) => {
  ...
  pool.query(queries.countAlertEtape, [date_alert, etape], (error, result) => {
    if (error) throw error;
    res.status(200).json(result.rows);
  });
};
...
countAlertEtapePrimary = (req, res) => {
  ...
  pool.query(
    queries.countAlertEtapePrimary,
    [date_alert, etape],
    (error, result) => {
      if (error) throw error;
      res.status(200).json(result.rows);
...
DataAlert = (req, res) => {
  ...
  pool.query(queries.DataAlert, [date_alert], (error, result) => {
    if (error) throw error;
    res.status(200).json(result.rows);
  });
};
DataAlertPrimary = (req, res) => {
  ...
  pool.query(queries.DataAlertPrimary, [date_alert], (error, result) => {
    if (error) throw error;
    res.status(200).json(result.rows);
  });
};
