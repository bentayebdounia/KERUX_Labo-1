...
const Navbar = () => {
  ...
  const [showJournalProduitFourni, setShowJournalProduitFournit] =
    useState(false);
  const handleCloseJournalRProduitFourni = () =>
    setShowJournalProduitFournit(false);
  const handleShowJournalProduitFourni = () =>
    setShowJournalProduitFournit(true);
  ...
  const [showStatistiqueProdType, setShowstatistique_prodtype] =
    useState(false);
  const handleCloseStatistiqueProdType = () =>
    setShowstatistique_prodtype(false);
...
*/
  return (
    <div>
        ...
        <div className="container-fluid" id="divContainer">
          ...
          <ul className="dropdown-menu menubar" style={{ marginLeft: "38%" }}>
            ...
            <li>
              ...
              <button
                ...
                type="button"
                onClick={() => {
                  handleShowJournalProduitFourni();
                }}
              >
            ...
            <li>
              ...
              <button
                ...
                type="button"
                onClick={() => {
                  handleShowJournalNettoyage();
                  setJournalProcess("enregistrement");
                }}
              >
                Journal de enregistrement
              </button>{" "}
            </li>
            <li>
              {" "}
            ...
            <li>
              ...
              <button
                ...
                onClick={() => {
                  handleShowJournalNettoyage();
                  setJournalProcess("conditionnement");
                }}
              >
                Journal de conditionnement
              </button>{" "}
            </li>
            <li>
              {" "}
          ...
          <ul className="dropdown-menu menubar" style={{ marginLeft: "45%" }}>
            <li>
              ...
              <button
                className="dropdown-item"
                type="button"
                onClick={handleShowMouvementStock}
              >
                Movement de stock
              </button>{" "}
            </li>
          ...
          <ul className="dropdown-menu menubar" style={{ marginLeft: "50%" }}>
            <li>
              ...
              <button
                ...
                type="button"
                onClick={() => {
                  handleShowStatistiqueProd();
                }}
              >
                Statistique des categories produits{" "}
              </button>{" "}
            </li>
            <li>
              {" "}
              <button
                ...
                type="button"
                onClick={() => {
                  handleShowStatistiqueProdType();
                }}
              >
                Statistique des types produits{" "}
              </button>{" "}
            </li>
            <li>
              {" "}
              <button
                ...
                type="button"
                onClick={() => {
                  handleShowStatProcessProd();
                }}
              >
                Statistique des process{" "}
              </button>{" "}
            </li>
          </ul>
          ...
          <Link className="nav-link active " to="#" onClick={toggleAlertTrue}>
            <i className="bell bi bi-bell-fill me-2" id="bell">
              <span
                className="position-absolute top-0 start-1 translate-middle badge rounded-pill bg-danger text-light"
          ...
          <Link
            className="nav-link p-5 position-absolute end-0 "
            to="#"
            role="button"
            data-bs-toggle="dropdown"
      ...
      {toggleAlert && (
        <ModelAlert show={toggleAlert} handleClose={toggleAlertFalse} />
      )}
    </div>
  );
};
