...
const AffichageBoxes = (props) => {
  ...
  const champtVerify = () => {
    if (entrepot === "" || entrepot === undefined || entrepot === null)
      ...
      (entrepot !== "" || entrepot !== undefined || entrepot !== null) &&
      date_alert !== ""
    ) {
      //alert(date_alert)
      return true;
      ...
      for (var i = 0; i < tab.length; i++) {
        ...
        if (i === key) {
          ...
          if (poids !== "") {
            //alert(entrepot)
            var poidsResterNv =
              parseFloat(props.poidsRester) + parseFloat(tab[i].poids);
            tab[i].poids = poids * 1000;
            boxe[i].poids = poids * 1000;
            //alert("rest"+ poidsResterNv-parseFloat(  tab[i].poids) )
            props.modifierPoidsRester(
              tab[i].id_produit,
              poidsResterNv - parseFloat(tab[i].poids)
            );
          } else {
                        ...
                        <>
                          ...
                          <td>
                            ...
                            {entrepot !== "" && date_alert === "" && (
                              <p style={{ color: "red", fontSize: "11px" }}>
                                {" "}
                                *Veillez ajouter la date d'alerte{" "}
                              </p>
                            )}
                          </td>
                          <td>
