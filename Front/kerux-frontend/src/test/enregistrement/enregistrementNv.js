...
*/
    ...
    if (
      ...
      if (categorie === "poulet") {
        if (
          ...
          if (
            verificationPoids(poids_fourni, nombre_fourni, unite) >= 1500 &&
            verificationPoids(poids_fourni, nombre_fourni, unite) <= 2500
          )
            plus();
          else {
          ...
          {erreurNombre === true &&
            (nombre_fourni === "" ||
              ...
              <p style={{ color: "red", fontSize: "11px" }}>
                {" "}
                *Veillez ajouter le nombre fourni{" "}
              </p>
            )}
        </div>
      </>
  ...
  return (
    <>
                ...
                <div className="row gy-2 gx-2 align-items-center">
                  <div className="row mb-2">
                    ...
                    <div className="col-4 ">
                      ...
                      {erreurCategorie === true && categorie === "" && (
                        <p style={{ color: "red", fontSize: "11px" }}>
                          {" "}
                          *Veillez selectionner une categorie{" "}
                        </p>
                      )}
                    </div>
                    ...
                    <div className="col-4">
                      ...
                      {erreurProduit === true && nom_produit === "" && (
                        <p style={{ color: "red", fontSize: "11px" }}>
                          {" "}
                          *Veillez selectionner un type de produit{" "}
                        </p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-2">
                      <input
                        ...
                        value={poids_fourni}
                        onChange={(event) =>
                          setPoids_fourni(event.target.value)
                        }
                      />
                      {erreurPoids === true &&
                        (poids_fourni === "" ||
                          ...
                          <p style={{ color: "red", fontSize: "11px" }}>
                            {" "}
                            *Veillez ajouter le poids fourni{" "}
                          </p>
                        )}
                    </div>
                    ...
                    <tr key={key}>
                      <td style={{ textAlign: "center" }}>
                        <i
                          ...
                          style={{ color: "#7B170F" }}
                          onClick={() => {
                            supprimerProduitFourni(p.id_prod);
                          }}
                        ></i>
                      </td>
                      <td>{p.categorie}</td>
                      ...
                      <td style={{ textAlign: "center" }}>
                        {p.poidsRester !== 0 && (
                          <button
                            ...
                            onClick={() => {
                              ...
                              setPoidsrester(p.poidsRester);
                              setNombrerester(p.nombreRester);
                              handleShow();
                            }}
                          >
                            {" "}
                        ...
                        {p.poidsRester < p.poids_fourni && (
                          <button
                            className="btnTableAfficher"
                            onClick={() => {
                              AfiicherBoxes(p.id_prod, p.poidsRester);
                            }}
                          >
                            {" "}
                            <i
      ...
      {toggle === true && (
        <Reception recepBtn={props.recepBtn} enrgBtn={props.enrgBtn} />
      )}
    </>
  );
};
