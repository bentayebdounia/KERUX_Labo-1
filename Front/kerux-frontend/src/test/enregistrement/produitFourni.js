  ...
  if (props.categorie === "poulet") {
    ...
    nbr = (
      <div className="form-floating">
        ...
        />
        <label for="nbr" style={{ color: "#000", fontWeight: "bold" }}>
          Nombre fourni
        </label>
      ...
      <div className="row gy-2 gx-2 align-items-left">
        <div className="col-6">
          <div className="form-floating  ">
            <select
              ...
              onChange={(event) => {
                props.onCategorieChange(event.target.value);
              }}
              required
            >
          ...
          {props.erreurCategorie === true && props.categorie === "" && (
            <p style={{ color: "red", fontSize: "11px" }}>
              {" "}
        ...
        <div className="col-6 ">
          <div className="form-floating">
            <select
              ...
              onChange={(event) => {
                props.onNom_produitChange(event.target.value);
              }}
              required
            >
              {TypePoulet}
            ...
            <label for="produit" style={{ color: "#000", fontWeight: "bold" }}>
              Type de produit
            </label>
          </div>
          {props.erreurProduit === true && props.nom_produit === "" && (
            <p style={{ color: "red", fontSize: "11px" }}>
              {" "}
        ...
        <div className="col-5 " style={{ paddingRight: "0px" }}>
          <div className="form-floating">
            ...
            <label for="poids" style={{ color: "#000", fontWeight: "bold" }}>
              Poids fourni
            </label>
          </div>
        ...
        <div className="col-6 mb-3">{nbr}</div>
      </div>
    </>
  );
}
