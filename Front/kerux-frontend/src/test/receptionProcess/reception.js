...
const Reception = (props) => {
  ...
  const [activiteFurnisseur, setActiviteFournisseur] = useState("");
  ...
  const getVlue = () => {
    serviceFournisseur
      .getFournisseurByNomOrActiviteOrId(nom_fournisseur, nom_fournisseur)
      .then((res) => {
          ...
          {fournisseur.map((value) => {
            return (
              <a
                ...
                onClick={() => {
                  setNomFournisseur(value.nom_fournisseur);
                  setFk_fournisseur(value.id_fournisseur);
                  setActiviteFournisseur(value.activite);
                }}
              >
                <p>
