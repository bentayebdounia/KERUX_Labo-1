  ...
  return (
    <>
      <div className="container" id="stepComponant">
            ...
            {controleReceptionV === false && (
              <>
                <div
                  ...
                  style={{
                    color: `${
                      controleReception === true ? "#F6A51A" : "#D4D4D4"
                    }`,
                  }}
                  id="etape1"
                ></div>
            ...
            {controleEnrgV === false && (
              <>
                <div
                  ...
                  style={{
                    color: `${controleEnrg === true ? "#F6A51A" : "#D4D4D4"}`,
                  }}
                  id="etape1"
                ></div>
                <div
            ...
            {controleNettoyageV === false && (
              <>
                <div
                  ...
                  style={{
                    color: `${
                      controleNettoyage === true ? "#F6A51A" : "#D4D4D4"
                    }`,
                  }}
                  id="etape1"
                ></div>
            ...
            {controleCoupageV === false && (
              <>
                <div
                  ...
                  style={{
                    color: `${
                      controleCoupage === true ? "#F6A51A" : "#D4D4D4"
                    }`,
                  }}
                  id="etape1"
                ></div>
            ...
            {controleConditV === false && (
              <>
                <div
                  ...
                  style={{
                    color: `${controleCondit === true ? "#F6A51A" : "#D4D4D4"}`,
                  }}
                  id="etape1"
                ></div>
                <div
            ...
            {controleSortieV === false && (
              <>
                <div
                  ...
                  style={{
                    color: `${controleSortie === true ? "#F6A51A" : "#D4D4D4"}`,
                  }}
                  id="etape1"
                ></div>
                <div
        ...
        {controleReception && (
          <Reception recepBtn={recepBtn} enrgBtn={enrgBtn} />
        )}
        {controleNettoyage && (
          <TestNet nettoypBtnV={nettoypBtnV} nettoypBtn={nettoypBtn} />
        )}
        {controleCoupage && (
          <TestCoupage coupBtnV={coupBtnV} coupBtn={coupBtn} />
        )}
        {controleCondit && (
          <TestCondit conditBtnV={conditBtnV} conditBtn={conditBtn} />
        )}
        {controleSortie && (
          <TestSortie sortieBtnV={sortieBtnV} sortieBtn={sortieBtn} />
        )}
      </div>
    </>
  );
