...
const ModifierAlert = (props) => {
    ...
    const [ idBoxe, setIdboxe] = useState("")
    ...
    const chercher = async() => {
        ...
        serviceActuelProcess.getIdProcess(etape , idBoxe)
            .then((res) => {
        ...
        <>
            <Modal size="xl" scrollable={true} show={props.show} onHide={props.handleClose}>
                ...
                <Modal.Body>
                    ...
                    <div style={{margin:"5%", marginRight:"5%"}}>
                        ...
                        <div className="mb-2 row">
                            ...
                            <label htmlFor="etape" className="col-sm-1 form-label">Etape</label>
                                <select className="form-select" aria-label="Default select example" id="etape" value={etape} onChange={(e)=> setEtape(e.target.value)}  required>
                                <option value=""></option>
                            ...
                            <label className="col-sm-3 form-label">ID de boxe</label>
                                <input  type="text" className="form-control " value={idBoxe} onChange={(e)=> setIdboxe(e.target.value)} />
                            </div>
                ...
                <Modal.Footer>
                        ...
                        <button type="button" className="btn btn-success" onClick={ ()=> chercher() } >MODIFIER</button>
